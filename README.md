...
### This repo is dedicated to my personal front-end projects where I develop simple games and apps as a hobby. 
...
### Finished projects (available on the website):
- `Snake Game`
- `Wordle Game`
- `Caesar Cipher (encoder/decoder)`
- `Typer Racer (single-player)`
- `Memory Game`
